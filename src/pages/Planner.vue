    ...
    <div class="main-workspace" :class="{ 'hub-active': hubTab !== 'plan' }">
      ...
      <aside class="left_panel">
        <div class="left_panel-header">
          ...
          <!-- <v-btn text="" @click="startNewChat" class="">
          ...
          <button @click="startNewChat" class="sidebar-toggle">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-message-square-plus-icon lucide-message-square-plus"><path d="M22 17a2 2 0 0 1-2 2H6.828a2 2 0 0 0-1.414.586l-2.202 2.202A.71.71 0 0 1 2 21.286V5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2z" />
              <path d="M12 8v6" />
              <path d="M9 11h6" />
            </svg>
          </button>
