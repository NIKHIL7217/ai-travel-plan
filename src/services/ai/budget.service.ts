  ...
  if (API_KEY) {
    try {
      ...
      const prompt = `
        ...
        The user may write in casual or mixed language; understand the input, but RESPOND ONLY IN ENGLISH — do not use Hinglish or Hindi in any output.
        Understand and estimate a practical budget.
